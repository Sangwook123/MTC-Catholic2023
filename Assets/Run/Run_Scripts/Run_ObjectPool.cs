...
public class Run_ObjectPool : MonoBehaviour
{
    public static Run_ObjectPool instance;

    [SerializeField] Run_ObjectInfo[] objectInfo = null;
    ...
    Queue<GameObject> InsertQueue(Run_ObjectInfo p_objectInfo)
    {
